...
export const adminTabs = [
  ...
  { label: 'Clases', icon: <EventIcon />, route: '/dashboard/administrator/classes' },
...
export const recepcionistTabs = [
  ...
  { label: 'Planes', icon: <AssignmentIcon />, route: '/dashboard/administrator/plans' },
  { label: 'Clases', icon: <EventIcon />, route: '/dashboard/receptionist/classes' },
...
export const memberTabs = [
  ...
  { label: 'Clases', icon: <EventIcon />, route: '/dashboard/member/classes' },
