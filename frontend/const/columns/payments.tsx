...
export const columnsPayments = (
  ...
  handleDelete: (id: number) => void
    ...
    },
    {
      ...
      flex: 0.14,
      ...center,
      renderCell: (params) => ARS.format(Number(params.row?.monto ?? 0)),
    },
    {
      field: 'metodo_de_pago_id',
      headerName: 'Método de pago',
      flex: 0.16,
      ...center,
      renderCell: (params) => String(getMetodoPago(params.row) ?? '—'),
    },
    {
      field: 'tipo', headerName: 'Tipo', flex: 0.12, ...center,
